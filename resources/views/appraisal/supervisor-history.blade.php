...
<div class="max-w-6xl mx-auto">
  ...
  <div class="flex items-start justify-between flex-wrap gap-3 mb-6">
    <div>
      ...
      <div class="text-sm text-gray-500 mt-0.5">Every appraisal for your team, across every cycle — past and present.</div>
    </div>
  ...
  {{-- Filter bar --}}
  <form method="GET" action="{{ route('supervisor.appraisal.history') }}" class="bg-white border border-[#e0daf5] rounded-2xl p-4 sm:p-5 mb-6 shadow-sm">
    ...
    <div class="flex items-center gap-2 mt-4">
      ...
      <a href="{{ route('supervisor.appraisal.history') }}" class="inline-flex items-center gap-1.5 text-sm text-gray-500 px-4 py-2 rounded-lg border border-[#e0daf5] hover:bg-[#f5f0ff] transition">
          ...
          <tbody class="divide-y divide-[#f0edf8]">
            ...
            <tr class="hover:bg-[#faf8ff] transition">
              ...
              <td class="py-3.5 px-4 text-right">
                <a href="{{ route('supervisor.appraisal.show', $appraisal) }}" class="inline-flex items-center gap-1 text-xs border border-[#7F77DD] text-[#3C3489] px-3 py-1.5 rounded-lg hover:bg-[#eeedfe] transition">
