    ...
    public function staffStore(Request $request)
{
    $request->validate([
        ...
        'challenge_identified'  => 'nullable|string', // Add this validation rule
        'challenge_impact'      => 'nullable|string', // Add this validation rul
        'category'              => 'required|in:KRA,Routine,Innovation',
...
private function syncToAppraisal(TaskLog $taskLog, Appraisal $appraisal)
{
    $model = match($taskLog->category) {
        ...
        'Innovation' => AppraisalInnovation::class,
